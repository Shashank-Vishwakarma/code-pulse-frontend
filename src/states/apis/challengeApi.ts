...
export const challengeApi = createApi({
    ...
    baseQuery: fetchBaseQuery({
        baseUrl: `${process.env.NEXT_PUBLIC_API_BASE_URL}/api/v1/challenges`,
        credentials: "include",
    }),
    ...
    endpoints: (builder) => ({
        ...
        getCorrectAnswersForChallenge: builder.query<
            SingleChallengeDataWithCorrectAnswers,
            string
        >({
